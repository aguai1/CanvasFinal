...
//				}
	...
	private GUIDE_DETAIL currentGuide=GUIDE_DETAIL.TYPE_VEDIO_HIGH_VALUE;
	enum GUIDE_TYPE{
		TYPE_VEDIO,
		TYPE_CHECK_IN,
		TYPE_FEELINGLUCKY
	...
	enum GUIDE_DETAIL{
		TYPE_VEDIO_NO_HIGH_VALUE,
		TYPE_VEDIO_HIGH_VALUE,
		TYPE_VEDIO_NO_LOW_VALUE,
		TYPE_VEDIO_LOW_VALUE,
		TYPE_CHECK_IN,
		TYPE_FEELINGLUCKY
	}
...
//		if (!SharedPreferencesUtil.isNewRegisterUser())return;
	...
	private void refreshGuide() {
		if (guideContainer==null||guideView==null||!hasShowOne)return;
		...
		if (guideContainer.isShow()){
			switch (currentGuide){
				...
				case TYPE_FEELINGLUCKY:
					showGuideFeelingLucky();
					break;
				case TYPE_VEDIO_HIGH_VALUE:
					showGuideVideoHighValueCountry();
					break;
				case TYPE_VEDIO_NO_LOW_VALUE:
					showGuideNoVideoLowValueCountry();
					break;
				case TYPE_VEDIO_LOW_VALUE:
					showGuideVideoLowValueCountry();
					break;
				case TYPE_VEDIO_NO_HIGH_VALUE:
					showGuideNoVideoHighValueCountry();
					break;
				default:return;
			}
	...
	private void showGuideVideoHighValueCountry() {
		currentGuide=GUIDE_DETAIL.TYPE_VEDIO_HIGH_VALUE;
		guideContainer.clearAllView();
	...
	private void showGuideVideoLowValueCountry() {
		currentGuide=GUIDE_DETAIL.TYPE_VEDIO_LOW_VALUE;
		guideContainer.clearAllView();
	...
	private void showGuideNoVideoLowValueCountry() {
		currentGuide=GUIDE_DETAIL.TYPE_VEDIO_NO_LOW_VALUE;
		guideContainer.clearAllView();
	...
	private void showGuideNoVideoHighValueCountry() {
		currentGuide=GUIDE_DETAIL.TYPE_VEDIO_NO_HIGH_VALUE;
		guideContainer.clearAllView();
